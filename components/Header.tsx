...
const Header: React.FC = () => {
  ...
  return (
    <header className="relative bg-gray-800 text-white min-h-[85vh] md:min-h-screen flex items-center justify-start text-left p-8 md:px-16 lg:px-24">
      <style>
        {`
          .shine-button {
            position: relative;
      ...
      <div className="relative z-10 flex flex-col items-start">
        <Logo />
        <h2 className="text-3xl sm:text-4xl md:text-6xl font-extrabold leading-tight mt-6 mb-4 max-w-4xl uppercase text-black">
          NOVA COLEÇÃO<br />TROPICAL 2026
          <span className="font-baloo block my-1 text-6xl sm:text-8xl md:text-[10rem] md:leading-[1] font-extrabold text-black">PAPELIÊ</span>
        </h2>
        <p className="text-lg md:text-2xl font-light mb-8 text-black">
